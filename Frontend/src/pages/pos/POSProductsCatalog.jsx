  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-2xs flex items-center gap-3">
        ...
        <div className="text-xs font-semibold text-slate-500 bg-slate-100 px-3 py-2 rounded-xl border border-slate-200 shrink-0">
        ...
        {loading ? (
          ...
          filteredProducts.map((prod) => {
            ...
            return (
              <div
                key={prod.id}
                className="bg-white rounded-2xl border border-slate-200 p-4 shadow-2xs hover:border-blue-400 hover:shadow-md transition flex flex-col justify-between"
              >
                <div>
                  ...
                  <p className="text-lg font-black text-slate-900 mt-1">₹{priceVal.toFixed(2)}</p>
                </div>

                {/* QR Code Center */}
                <div className="my-4 flex flex-col items-center justify-center p-3 bg-slate-50 border border-slate-100 rounded-xl">
                ...
                <button
                  onClick={() => navigate("/pos/billing")}
                  className="w-full flex items-center justify-center gap-1.5 py-2 px-3 rounded-xl bg-blue-50 hover:bg-blue-100 text-blue-700 text-xs font-bold border border-blue-200 transition"
                >
