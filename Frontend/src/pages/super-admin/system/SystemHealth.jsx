...
import { Activity, Server, Database, Globe, Cpu, HardDrive, Zap, CheckCircle2, AlertTriangle } from "lucide-react";
    ...
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-5 rounded-2xl bg-white border border-slate-100 shadow-[0_2px_8px_rgba(0,0,0,0.04)]">
          ...
          <div className="text-2xl font-bold text-gray-900 font-mono">18.4%</div>
          <div className="w-full h-1.5 rounded-full bg-gray-100 mt-3 overflow-hidden">
            <div className="h-full bg-blue-600 rounded-full" style={{ width: "18.4%" }} />
          </div>
        </div>
        ...
        <div className="p-5 rounded-2xl bg-white border border-slate-100 shadow-[0_2px_8px_rgba(0,0,0,0.04)]">
          ...
          <div className="text-2xl font-bold text-gray-900 font-mono">2.4 / 8 GB</div>
          <div className="w-full h-1.5 rounded-full bg-gray-100 mt-3 overflow-hidden">
        ...
        <div className="p-5 rounded-2xl bg-white border border-slate-100 shadow-[0_2px_8px_rgba(0,0,0,0.04)]">
          ...
          <div className="text-2xl font-bold text-gray-900 font-mono">42 / 200 GB</div>
          <div className="w-full h-1.5 rounded-full bg-gray-100 mt-3 overflow-hidden">
            <div className="h-full bg-cyan-600 rounded-full" style={{ width: "21%" }} />
          </div>
        </div>
        ...
        <div className="p-5 rounded-2xl bg-white border border-slate-100 shadow-[0_2px_8px_rgba(0,0,0,0.04)]">
          ...
          <div className="text-2xl font-bold text-gray-900 font-mono">64 ms</div>
          <div className="w-full h-1.5 rounded-full bg-gray-100 mt-3 overflow-hidden">
            <div className="h-full bg-emerald-600 rounded-full" style={{ width: "16%" }} />
          </div>
        </div>
      </div>
